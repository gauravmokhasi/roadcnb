	...
	<body>
		<div class="header" align=center>
			<div class="pure-g-r homebody">
				...
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h1>Which city would you like to visit?</h1></div></div>
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=right><h2>Welcome <?php echo $_SESSION['NAME']; ?></h2></div></div>

				<div class="pure-u-1-3"></div>			
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h2>Click a city to view available hotels and homes</h2></div></div>
