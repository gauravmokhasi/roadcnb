	...
	<body>
		...
		while($row = mysql_fetch_assoc($result)){			
			echo '<div class="pure-u-1-2 hotelname">
				...
				<div class="pure-u-1-1 white" style="margin-left:184px !important;"><a href="book.php?type=hotel&hid='.$row['hotelid'].'&cityid='.$cid.'&success=0"><input type="button" value="Yes this is where I want to stay" /></a></div>		
			</div>'; 
		...
		while($row = mysql_fetch_assoc($result))
		{
			echo '<div class="pure-u-1-2 homename">
				...
				<div class="pure-u-1-1 white"><h2><div class="white">DESCRIPTION:     	 '.$row['description'].'</div><h2></div>
				...
				<div class="pure-u-1-1" style="margin-left:184px;"><a href="book.php?type=home&hid='.$row['homeid'].'&cityid='.$cid.'&success=0"><input type="button" value="Yes this is where I want to stay" /></a></div>				
				<br/>
			</div>';
		}
		?>	
