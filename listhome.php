	...
	<body>
		<div class="header" align=center>
			<div class="pure-g-r homebody">
				...
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h1>Which home do you want to rent out?</h1></div></div>
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=right><h2>Welcome <?php echo $_SESSION['NAME']; ?></h2></div></div>

				<div class="pure-u-1-3"></div>			
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h2>Pick the city that home is in</h2></div></div>
...
<div class='row clearfix '><label class='span3'>Rooms</label>
...
<div class='pull-right'><input type='submit' class='btn primary wide' value='Sign Up &raquo;' /></div>
</fieldset>
</form></div></div>
