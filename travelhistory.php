...
<html>
	<head>
		...
		<title>RoadCnB Travel History </title>
	</head>
	<body>
		...
		<div class="pure-g-r homebody">
				...
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h1>Travel History</h1></div></div>
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=right><h2>Welcome <?php echo $_SESSION['NAME']; ?></h2></div></div>
				
				<div class="pure-u-1-3"></div>
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h2>Hotels and Homes you've stayed at</h2></div></div>
				...
				<div class="pure-g-r homebody">
					<div class="pure-u-1-1 white">
						...
						<div class="pure-u-1-2 white">
							...
							<div class="pure-u-1-2 white"><h2><div class="white" align=center>PLACE OF STAY: '.$row['place_of_stay'].'</div></h2></div>
